<template>
  <div id="me">
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      <router-link class="navbar-brand col-sm-3 col-md-2 mr-0" to="/home">来捧鲜花商店</router-link>
          ...
          <div class="sidebar-sticky">
            ...
            <el-menu
              ...
              <el-submenu index="3">
                ...
                <el-menu-item-group>
                  <el-menu-item index="3-1" @click="goTo('/me/sales?state=2')">待完成订单</el-menu-item>
                  <el-menu-item index="3-2" @click="goTo('/me/sales?state=1')">已完成订单</el-menu-item>
                </el-menu-item-group>
              </el-submenu>
            </el-menu>
          </div>
