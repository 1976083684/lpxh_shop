...
// 注册
export const register = (name, pwd ) => ajax(BASE_URL + '/api/register', {name, pwd}, 'POST');
...
// 加入购物车
export const pay = (ids,state=1,address) => ajax(BASE_URL + '/api/pay', {state,ids,address}, 'POST');



// 去支付
 export const payment = (params) => ajax(BASE_URL + '/api/payment',params,'POST');


 export const queryOrder = (params) => ajax(BASE_URL + '/api/queryOrder',params,'POST');
...
// 请求统计
export const getstatistics = () => ajax(BASE_URL + '/api/statistics');



// 请求订单
export const get_orders = () => ajax(BASE_URL + '/api/orders');


// 请求订单
export const get_user_orders = (params) => ajax(BASE_URL + '/api/user_orders',params);
